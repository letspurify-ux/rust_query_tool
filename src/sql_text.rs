...
pub(crate) fn is_statement_head_keyword(word: &str) -> bool {
    word.eq_ignore_ascii_case("DECLARE")
        ...
        || word.eq_ignore_ascii_case("EXEC")
        || word.eq_ignore_ascii_case("EXECUTE")
        || word.eq_ignore_ascii_case("START")
        || word.eq_ignore_ascii_case("PROMPT")
        || word.eq_ignore_ascii_case("CONNECT")
        || word.eq_ignore_ascii_case("DISCONNECT")
        || word.eq_ignore_ascii_case("SPOOL")
        || word.eq_ignore_ascii_case("DEFINE")
        || word.eq_ignore_ascii_case("WHENEVER")
        || word.eq_ignore_ascii_case("VARIABLE")
        || word.eq_ignore_ascii_case("VAR")
        || word.eq_ignore_ascii_case("PRINT")
        || word.eq_ignore_ascii_case("ACCEPT")
        || word.eq_ignore_ascii_case("PAUSE")
        || word.eq_ignore_ascii_case("UNDEFINE")
        || word.eq_ignore_ascii_case("COLUMN")
        || word.eq_ignore_ascii_case("BREAK")
        || word.eq_ignore_ascii_case("CLEAR")
        || word.eq_ignore_ascii_case("COMPUTE")
        || word.eq_ignore_ascii_case("EXIT")
        || word.eq_ignore_ascii_case("QUIT")
        || word.eq_ignore_ascii_case("HOST")
        ...
        || word.eq_ignore_ascii_case("PURGE")
        || word.eq_ignore_ascii_case("FLASHBACK")
