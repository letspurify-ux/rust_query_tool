...
fn glyph_rows(ch: char) -> [u16; 9] {
    match ch {
        'A' => [
            0b0011100, 0b0100010, 0b0100010, 0b0100010, 0b0111110, 0b0100010, 0b0100010, 0b0100010,
            0b0000000,
        ],
        'B' => [
            0b0111100, 0b0100010, 0b0100010, 0b0111100, 0b0100010, 0b0100010, 0b0100010, 0b0111100,
            0b0000000,
        ],
        'C' => [
            0b0011100, 0b0100010, 0b0100000, 0b0100000, 0b0100000, 0b0100000, 0b0100010, 0b0011100,
            0b0000000,
        ],
        'D' => [
            0b0111000, 0b0100100, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100100, 0b0111000,
            0b0000000,
        ],
        'E' => [
            0b0111110, 0b0100000, 0b0100000, 0b0111100, 0b0100000, 0b0100000, 0b0100000, 0b0111110,
            0b0000000,
        ],
        'F' => [
            0b0111110, 0b0100000, 0b0100000, 0b0111100, 0b0100000, 0b0100000, 0b0100000, 0b0100000,
            0b0000000,
        ],
        'G' => [
            0b0011100, 0b0100010, 0b0100000, 0b0100000, 0b0100110, 0b0100010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        'H' => [
            0b0100010, 0b0100010, 0b0100010, 0b0111110, 0b0100010, 0b0100010, 0b0100010, 0b0100010,
            0b0000000,
        ],
        'I' => [
            0b0111110, 0b0001000, 0b0001000, 0b0001000, 0b0001000, 0b0001000, 0b0001000, 0b0111110,
            0b0000000,
        ],
        'L' => [
            0b0100000, 0b0100000, 0b0100000, 0b0100000, 0b0100000, 0b0100000, 0b0100000, 0b0111110,
            0b0000000,
        ],
        'M' => [
            0b0100010, 0b0110110, 0b0101010, 0b0101010, 0b0100010, 0b0100010, 0b0100010, 0b0100010,
            0b0000000,
        ],
        'N' => [
            0b0100010, 0b0110010, 0b0101010, 0b0101010, 0b0100110, 0b0100010, 0b0100010, 0b0100010,
            0b0000000,
        ],
        'O' => [
            0b0011100, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        'P' => [
            0b0111100, 0b0100010, 0b0100010, 0b0111100, 0b0100000, 0b0100000, 0b0100000, 0b0100000,
            0b0000000,
        ],
        'Q' => [
            0b0011100, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0101010, 0b0100100, 0b0011010,
            0b0000000,
        ],
        'R' => [
            0b0111100, 0b0100010, 0b0100010, 0b0111100, 0b0101000, 0b0100100, 0b0100010, 0b0100010,
            0b0000000,
        ],
        'S' => [
            0b0011110, 0b0100000, 0b0100000, 0b0011100, 0b0000010, 0b0000010, 0b0000010, 0b0111100,
            0b0000000,
        ],
        'T' => [
        ...
        'U' => [
            0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        'V' => [
            0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0010100, 0b0010100, 0b0001000,
            0b0000000,
        ],
        'W' => [
            0b0100010, 0b0100010, 0b0100010, 0b0100010, 0b0101010, 0b0101010, 0b0110110, 0b0100010,
            0b0000000,
        ],
        'X' => [
            0b0100010, 0b0100010, 0b0010100, 0b0001000, 0b0001000, 0b0010100, 0b0100010, 0b0100010,
            0b0000000,
        ],
        'Y' => [
            0b0100010, 0b0100010, 0b0010100, 0b0001000, 0b0001000, 0b0001000, 0b0001000, 0b0001000,
            0b0000000,
        ],
        '0' => [
            0b0011100, 0b0100010, 0b0100110, 0b0101010, 0b0110010, 0b0100010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        '1' => [
            0b0001000, 0b0011000, 0b0001000, 0b0001000, 0b0001000, 0b0001000, 0b0001000, 0b0011100,
            0b0000000,
        ],
        '2' => [
            0b0011100, 0b0100010, 0b0000010, 0b0000100, 0b0001000, 0b0010000, 0b0100000, 0b0111110,
            0b0000000,
        ],
        '3' => [
            0b0011100, 0b0100010, 0b0000010, 0b0001100, 0b0000010, 0b0000010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        '4' => [
            0b0000100, 0b0001100, 0b0010100, 0b0100100, 0b0111110, 0b0000100, 0b0000100, 0b0000100,
            0b0000000,
        ],
        '5' => [
            0b0111110, 0b0100000, 0b0100000, 0b0111100, 0b0000010, 0b0000010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        '6' => [
            0b0011100, 0b0100000, 0b0100000, 0b0111100, 0b0100010, 0b0100010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        '7' => [
            0b0111110, 0b0000010, 0b0000100, 0b0001000, 0b0001000, 0b0010000, 0b0010000, 0b0010000,
            0b0000000,
        ],
        '8' => [
            0b0011100, 0b0100010, 0b0100010, 0b0011100, 0b0100010, 0b0100010, 0b0100010, 0b0011100,
            0b0000000,
        ],
        '9' => [
            0b0011100, 0b0100010, 0b0100010, 0b0011110, 0b0000010, 0b0000010, 0b0000010, 0b0011100,
            0b0000000,
        ],
        '.' => [
            0b0000000, 0b0000000, 0b0000000, 0b0000000, 0b0000000, 0b0000000, 0b0011000, 0b0011000,
            0b0000000,
        ],
        ' ' => [0; 9],
        _ => [0; 9],
    ...
    for y in 0..height {
        for x in 0..width {
            ...
            for (k, weight) in KERNEL.iter().enumerate() {
                ...
                let idx = y * width + sx;
                sum += mask.get(idx).copied().unwrap_or(0) as f32 * *weight;
            }
    ...
    for y in 0..height {
        for x in 0..width {
            ...
            for (k, weight) in KERNEL.iter().enumerate() {
                ...
                let idx = sy * width + x;
                sum += temp.get(idx).copied().unwrap_or(0) as f32 * *weight;
            }
        ...
        for col in 0..(GLYPH_COLS - 1) {
            ...
            if tl && br && !tr && !bl {
                ...
                if tr_exterior && (!bl_exterior || tr_score > bl_score) {
                    ...
                    && (!tr_exterior || bl_score > tr_score)
                    && !should_skip_glyph_triangle_fill(ch, row, col, TriangleCutCorner::BottomLeft)
                {
                    draw_cell_corner_triangle(
                        mask,
                        width,
                ...
                if tl_exterior && (!br_exterior || tl_score > br_score) {
                    ...
                    && (!tl_exterior || br_score > tl_score)
                    && !should_skip_glyph_triangle_fill(
                        ch,
                        row,
                        col,
