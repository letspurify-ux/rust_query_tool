...
#[test]
fn test_split_script_items_external_language_clause_splits_before_relative_run_script_command() {
    let sql = r#"CREATE OR REPLACE FUNCTION ext_lang_rel_cmd RETURN NUMBER
AS LANGUAGE C;
@@child.sql
SELECT 2 FROM dual;"#;
...
#[test]
fn test_split_format_items_external_language_clause_splits_before_relative_run_script_command() {
    let sql = r#"CREATE OR REPLACE FUNCTION ext_lang_rel_cmd RETURN NUMBER
AS LANGUAGE C;
@@child.sql
SELECT 2 FROM dual;"#;
